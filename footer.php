...
<footer class="site-footer">
  ...
  <div class="rb-container rb-payment-strip" aria-label="Kartlı ödeme markaları">
    <div class="rb-payment-strip__copy"><strong>Kartlı ödeme</strong><span>Ödeme altyapısı aktif edildiğinde desteklenen kart markaları burada gösterilir.</span></div>
    <div class="rb-payment-logos" aria-label="Visa Mastercard Troy">
...
@media(max-width:700px){.rb-cookie{left:12px;right:12px;bottom:12px}.rb-cookie__inner{display:grid;padding:18px}.rb-cookie__actions{width:100%}.rb-cookie__actions .rb-btn{flex:1}.rb-payment-strip{align-items:flex-start;flex-direction:column}.rb-payment-logos{justify-content:flex-start}.rb-whatsapp{left:14px;bottom:14px;width:52px;height:52px}.rb-whatsapp svg{width:27px;height:27px}.rb-scroll-top{right:14px;bottom:14px}.site-footer__grid{grid-template-columns:1fr}}
</style>
