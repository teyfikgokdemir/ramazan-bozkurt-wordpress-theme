...
<footer class="site-footer">
  <div class="rb-container site-footer__grid">
    <div class="site-footer__brand">
      ...
      <p class="rb-footer-company">Ramazan Bozkurt<br>Süleymanlı Mah. 6952. Sk. No: 47<br>38280 Talas / Kayseri<br><a href="tel:<?php echo esc_attr($rb_phone_tel); ?>"><?php echo esc_html($rb_phone_display); ?></a></p>
    </div>
    <div>
      <h2>Blog</h2>
