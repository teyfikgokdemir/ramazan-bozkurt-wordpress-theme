...
function rb_other_products_section() {
    ...
    echo '<div class="rb-other-products__head"><div><span class="rb-eyebrow">Sofranızı tamamlayın</span><h2>Diğer ürünleri de keşfedin</h2></div><a class="rb-text-link" href="' . esc_url(wc_get_page_permalink('shop')) . '">Tüm ürünler →</a></div>';
